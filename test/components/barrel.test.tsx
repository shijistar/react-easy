...
vi.mock('../../src/components/ConfirmAction/index', () => ({ default: () => null, withDefaultConfirmActionProps: () => () => null }));
vi.mock('../../src/components/ConfirmAction/withConfirmAction', () => ({ default: () => () => null, withConfirmActionInternal: () => () => null }));
vi.mock('../../src/components/ContextMenu', () => ({ default: () => null }));
vi.mock('../../src/components/DeleteConfirmAction/index', () => ({ default: Object.assign(() => null, { Button: () => null, Switch: () => null, Link: () => null }) }));
...
vi.mock('../../src/components/EllipsisTypography/EllipsisParagraph', () => ({ default: () => null, EllipsisParagraphProps: {} }));
vi.mock('../../src/components/EllipsisTypography/EllipsisText', () => ({ default: () => null, EllipsisTextProps: {} }));
vi.mock('../../src/components/EllipsisTypography/EllipsisTitle', () => ({ default: () => null, EllipsisTitleProps: {} }));
...
vi.mock('../../src/components/ModalAction/index', () => ({ default: () => null, withDefaultModalActionProps: () => () => null, withModalAction: () => null }));
