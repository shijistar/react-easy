...
export class ExtendTextNode extends TextNode {
  ...
  constructor(props?: ExtendTextNodeProps & { key?: NodeKey }) {
    ...
    this.__base = new BaseNodeHelper<ExtendTextNodeProps>(this.__props, {
      /* v8 ignore start -- Probe P3 empirical: below constructor overrides this.remove/this.replace, 
      BaseNodeHelper delegation (super.remove/super.replace) is never called */
      remove: () => super.remove(),
